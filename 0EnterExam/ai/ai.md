...
- [Тестирование (pytest)](./1-PythonProgramming.md#6-тестирование-pytest--python-测试pytest)
  测试
- [Packaging и окружения](./1-PythonProgramming.md#7-packaging-и-окружения--包管理与环境管理)
  包管理与环境管理
- [Профилировка и оптимизация](./1-PythonProgramming.md#8-профилировка-и-оптимизация--性能分析与优化)
  性能分析与优化
